...
datasets = {
    ...
    "MNI152_T1_2mm_brain_mask+dil": "MNI152_T1_2mm_brain_mask+dil.nii",
    ...
    "conte69_mask_lh": "conte69_mask_lh.gii",
    "conte69_mask_rh": "conte69_mask_rh.gii",
    "conte69_mask": "conte69_mask_bh.gii",
}

files = {
    "connectivity_config": "connectivity_config.json",
    "netstim_config": "netstim_config.json",
    "dataset_description_template": "dataset_description_template.json",
    "dbs_archive_config": "dbs_archive_config.json",
}
...
def get_img(ds):
    ...
    ds : str
        ...
        "fs5_mask_lh"
        "fs5_mask_rh"
        "fs5_mask" (bi-hemisphere concatenated LH/RH)
        "conte69_mask_lh"
        "conte69_mask_rh"
        "conte69_mask" (bi-hemisphere concatenated LH/RH)
